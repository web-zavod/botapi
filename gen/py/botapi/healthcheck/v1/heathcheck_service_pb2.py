...
# source: botapi/healthcheck/v1/heathcheck_service.proto
...
CheckResponse = _reflection.GeneratedProtocolMessageType('CheckResponse', (_message.Message,), {
  ...
  '__module__' : 'botapi.healthcheck.v1.heathcheck_service_pb2'
